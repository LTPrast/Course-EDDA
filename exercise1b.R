...
#Assuming normality we can do the following t-test. (we can state that there
#exists no significant departure from normality according shapiro test from 1a)
...
#since p>0.05 we do not reject H0, we do not have sufficient evidence to say that
