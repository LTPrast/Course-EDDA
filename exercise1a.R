...
#0.985 since 2-sided and confidence interval of 0.97,normal distribution is used
...
##### calculate the sample size when the length of the 97%-CI is at most 2 ####
#2E=2 so E=1
E = 1
#normal distribution is used since we can assume normality
...
#and we can use a bootstrap method
...
#bootstrap method has a smaller 97%-confidence interval compared to the method
#were we use the normal distribution 
